...
var MainLayout = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axiosInstance_1.default.get('/user/profile/')];
                    case 1:
                        response = _a.sent();
    ...
    return (react_1.default.createElement("div", { className: "flex" },
        ...
        react_1.default.createElement("div", { className: "flex-1 ml-64" },
            react_1.default.createElement(Navbar_1.default, { username: username }),
